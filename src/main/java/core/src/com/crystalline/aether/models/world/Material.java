...
public class Material {
    ...
    public static final float[][] TYPE_UNIT_SELECTOR = {
        {0,  50,  500, 5000, 50000, 500000}, /* Ether */
        {0,  10,  15,  70,   700,   1000}, /* Earth */
        {0,  50,  100, 1000, 10000, 100000},  /* Water */
        {0,  10,  100, 1000, 10000, 100000}, /* Air*/
        {10, 50,  100, 1000, 10000, 100000}, /* Fire */
        {0} /* Nothing */
    };
